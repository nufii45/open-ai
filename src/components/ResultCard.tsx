          ...
          {tabs.map(({ id, label, icon: Icon }) => {
            ...
            return (
              <button
                ...
                className={`inline-flex min-h-10 items-center justify-center gap-1.5 rounded-lg px-2 text-xs font-semibold transition-colors sm:text-sm ${
          ...
          <div className="space-y-6">
            <div className="rounded-2xl bg-emerald-50 px-4 py-5 text-center sm:px-6 sm:py-6">
              ...
              <p className="mt-2.5 text-sm text-emerald-800">
                {formatPercent(savings.savingsPercent)} lower for {comparison.packQuantity} {comparison.packUnit}
              </p>
            </div>
